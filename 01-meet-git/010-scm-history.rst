...
实际上，即便是在 CVS 出现之前的“史前时代”，已经出现了非常好用的源码比较和补丁工具： diff 和 patch，他们今天仍然非常有用。实际上在 1991-2002 年之间，Linus Torvalds一直顽固的用 diff 和 patch 管理着 Linux 的代码，即使不断有人提醒他 CVS 的存在。
...
大概是 Linus Torvalds 深受其害，在 Git 中，特意设计了新的 diff 格式，补充了对二进制的支持等功能。
